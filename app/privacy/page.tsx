  ...
  return (
    <main className="flex flex-col items-center px-4">
      <div className="max-w-2xl p-6">
        <h4 className="text-2xl font-bold mb-3 mt-5">Privacy Policy</h4>

        <p>
          We are very delighted that you have shown interest in our enterprise.
          Data protection is of a particularly high priority for the management
          of matehm.com. The use of the Internet pages of matehm.com is possible
        ...
        <p>
          ...
          matehm.com. By means of this data protection declaration, our
        ...
        <p>
          As the controller, matehm.com has implemented numerous technical and
        ...
        <h4 className="text-2xl font-bold mb-3 mt-5">1. Definitions</h4>
        <p>
          The data protection declaration of matehm.com is based on the terms
        ...
        <ul className="list-none">
          <li>
            <h4 className="text-2xl font-bold mb-3 mt-5">
              a&#41;&nbsp; Personal data
            </h4>
            <p>
        ...
        <p>
          The website of matehm.com collects a series of general data and
        ...
        <p>
          When using these general data and information, matehm.com does not
          ...
          cyber-attack. Therefore, matehm.com analyzes anonymously collected
        ...
        <p>
          The website of matehm.com contains information that enables a quick
        ...
        <ul className="list-none">
          ...
          <li>
            <h4 className="text-2xl font-bold mb-3 mt-5">b) Right of access</h4>
            <p>
              Each data subject shall have the right granted by the European
          ...
          <li>
            ...
            <p>
              ...
              FirmenName, he or she may, at any time, contact any employee of
              the controller. An employee of FirmenName shall promptly ensure
            ...
            <p>
              ...
              far as processing is not required. An employees of matehm.com will
          ...
          <li>
            ...
            <p>
              ...
              data stored by matehm.com, he or she may at any time contact any
              employee of the controller. The employee of matehm.com will
          ...
          <li>
            ...
            <p>
              ...
              may at any time contact any employee of matehm.com.
            </p>
          </li>
          <li>
            <h4 className="text-2xl font-bold mb-3 mt-5">g) Right to object</h4>
            <p>
              Each data subject shall have the right granted by the European
            ...
            <p>
              matehm.com shall no longer process the personal data in the event
            ...
            <p>
              If matehm.com processes personal data for direct marketing
              ...
              matehm.com to the processing for direct marketing purposes,
              matehm.com will no longer process the personal data for these
              purposes.
            </p>
            ...
            <p>
              ...
              personal data concerning him or her by matehm.com for scientific
            ...
            <p>
              ...
              contact any employee of matehm.com. In addition, the data subject
          ...
          <li>
            ...
            <p>
              ...
              consent, matehm.com shall implement suitable measures to safeguard
            ...
            <p>
              ...
              contact any employee of matehm.com.
            </p>
          </li>
          <li>
            <h4 className="text-2xl font-bold mb-3 mt-5">
        ...
        <p>
          ...
          <a href="https://abletotrain.com/">dpo training courses</a>. The legal
